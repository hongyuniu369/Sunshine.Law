...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        return (!string.IsNullOrEmpty(Zephyr.Core.FormsAuth.GetUserData().UserCode));
	...
	public override void SetConfig()
	{
        ...
        //BaseUrl = Zephyr.Areas.Msg.MsgHelper.GetCookies("CKFinder_Path");
		...
		type.DeniedExtensions = new string[] { };
        //type.AllowedMIMETypes = new string[] { "image/jpeg" };
        //type.DeniedMIMETypes = new string[] { };
