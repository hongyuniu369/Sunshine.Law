...
<script runat="server" language="C#">
	...
	protected override void OnLoad( EventArgs e )
	{
        ...
        CKEditor1.config.filebrowserBrowseUrl = "../../ckfinder.html";
        CKEditor1.config.filebrowserImageBrowseUrl = "../../ckfinder.html?Type=Images";
        CKEditor1.config.filebrowserFlashBrowseUrl = "../../ckfinder.html?Type=Flash";
        CKEditor1.config.filebrowserUploadUrl = "../../core/connector/aspx/connector.aspx?command=QuickUpload&type=Files";
        CKEditor1.config.filebrowserImageUploadUrl = "../../core/connector/aspx/connector.aspx?command=QuickUpload&type=Images";
        CKEditor1.config.filebrowserFlashUploadUrl = "../../core/connector/aspx/connector.aspx?command=QuickUpload&type=Flash";
        
        CKEditor1.HtmlEncodeOutput = true;
    }
