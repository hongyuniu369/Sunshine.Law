...
{
    public class CMSBaseApi<TMasterModel, TMasterService> : ApiController
        ...
        where TMasterService : ServiceBase<TMasterModel>, new()
    {
        ...
        public string projectCode { get { return CMSHelper.GetCurrentProject(); } }
        public string userName { get { return CMSHelper.GetUserName(); } }
...
<settings defaultOrderBy='{1}'>
    ...
    <where defaultForAll='true' defaultCp='equal' defaultIgnoreEmpty='true' >
        ...
        public virtual void Delete(string id)
        {
            ...
            CMSHelper.ThrowHttpExceptionWhen(result <= 0, "单据删除失败[" + keyField + "={0}]，请重试或联系管理员！", id);
        }
        #endregion
