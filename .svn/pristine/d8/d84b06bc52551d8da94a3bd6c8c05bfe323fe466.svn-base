...
namespace Zephyr.Core
{
    ...
    public partial class Cp
    {
        ...
        public static string Map(WhereData data)            { return SQL(data, "{0} in (select {0} from {2} where {3}='{1}')"); }
        ...
        public static string IsNullOrEmpty(WhereData data)  { return SQL(data, "({0} is Null or {0}='')"); }
        public static string IsNotNullOrEmpty(WhereData data) { return SQL(data, "({0} is Not Null And {0}!='')"); }
        public static string MapAlias(WhereData data) { return SQL(data, "{0} in (select {2} from {3} where {4}='{1}')"); }
        public static string ChildAlias(WhereData data) { return SQL(data, "{0} in (select ID from [dbo].[GetChild]('{2}','{1}'))"); }
        public static string MapChildAlias(WhereData data) { return SQL(data, "{0} in (select {2} from {3} where {4} in (select ID from [dbo].[GetChild]('{5}','{1}')))"); }
