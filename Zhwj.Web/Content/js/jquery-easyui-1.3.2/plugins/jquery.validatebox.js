...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"该输入项为必输项。",invalidMessage:null,tipPosition:"right",rules:{email:{validator:function(_26){
